...
class ModelTraining:
# This class is responsible for training the model using the provided data and parameters.
# It includes methods for loading data, splitting data, training the model, evaluating the model, and saving the model.
